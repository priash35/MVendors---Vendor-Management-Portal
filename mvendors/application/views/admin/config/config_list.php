...
<div class="content">
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title">Results for "Configuration List"</h5>
		...
		<table class="table table-bordered table-hover datatable-highlight">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $row->config_created ?></td>
					<td><?php echo $row->config_created ?></td>
					<td class="text-center">
						<a href="<?php echo base_url().'Configuration/update_config/'.$row->config_id;?>"><i class="icon-pencil7"></i></a>
					</td>
				</tr>
				<?php  }?>
			</tbody>

...
<div class="content">
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title">Results for "Completed User Enquiry List"</h5>
		...
		<table class="table table-bordered table-hover datatable-highlight">
			...
			<tbody>
				...
				<tr>
					...
					<!-- <td>Admin</td> -->
					<td><?php if($row->enq_status=='Completed'){?>
					<a href="#"><span class="badge badge-success">Completed</span></a>
					  <?php }else{ ?>
					<a href="#"><span class="badge badge-danger">Inctive</span></a>
					  <?php }?></td>
					<!-- <td class="text-center">
						<a href="<?php //echo base_url().'Advertise/update_slider/'.$row->enq_id;?>"><i class="icon-pencil7"></i></a>
						<a href="<?php //echo base_url().'Advertise/delete_slider/'.$row->enq_id;?>"onClick="return doconfirm();"><i class="icon-trash"></i></a>
					</td> -->
				</tr>
				<?php  }?>
			</tbody>

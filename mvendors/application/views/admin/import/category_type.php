  ...
  <br />
  <div id="imported_catbcsv_data"></div>
									</a>
			                	</div>
							</div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Import/load_categorydata",
   method:"POST",
   success:function(data)
   {
    $('#imported_catbcsv_data').html(data);
   }
  })
 }
 ...
 $('#import_csv').on('submit', function(event){
  ...
  $.ajax({
   url:"<?php echo base_url(); ?>Import/imports_category",
   method:"POST",

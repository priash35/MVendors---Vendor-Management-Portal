<script type="text/javascript">
    ...
    function liveSearch()                       //3 Jan 2019
      {
        var myNewURL = "mvendor/User/"; //the new URL
        ...
        else 
        {
         $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>User/search_cat",
...
<div id="page"> 
      ...
      <div class="header-top">
        <div class="container">
          <div class="row">
            ...
            <!-- live search on 3 Jan 2018-->
            <div class="col-lg-4 col-sm-4 hidden-xs " style="height: 55px;"> 
                <div class="row-fluid align-middle"  style="display: inline-block; width: 100%; margin-top: 10px; ">
                     <!--  <select class="selectpicker"  data-show-subtext="true" data-live-search="true" id="search_data" name="search-term" value="Search Product/Service " onblur="this.value=!this.value?'search':this.value;" onfocus="this.select()" onclick="this.value='';" onkeyup="liveSearch()" autocomplete="off" >
                        <div id="suggestions">
                        <option id ="autoSuggestionsList" data-subtext="Search Product/Service" ></option>
                        </div>
                      </select> -->
                  <input type="text" id="search_data" name="search-term" placeholder="Search Product/Service " onblur="this.value=!this.value?'Search Product/Service':this.value;" onfocus="this.select()" onclick="this.value='';" onkeyup="liveSearch()" autocomplete="off" class= "form-control align-middle" style="width: 100%; display: inline-block;">

                  <div id="suggestions" style="width: 90%;  background-color:#fff; z-index: 10;
    position: absolute; display:none;">
      
                      <ul class="ris" style="list-style: none;">
                        <li class="autoSuggestionsList" ></li>
                      </ul>
                ...
                <input type="text" id="search_data" name="search-term" value="Search Product/Service " onblur="this.value=!this.value?'search':this.value;" onfocus="this.select()" onclick="this.value='';" onkeyup="liveSearch()" autocomplete="off" class= "form-control">
               </form>
              <div id="suggestions" style="width:322px;position:fixed;top:100px;left:790px;background-color:#fffcfced;z-index:3; display:none;">
      
                <ul class="ris" style="list-style: none;">
                  <li id="autoSuggestionsList" style='padding:5px;margin-left:24px;margin-top:4px;'></li>
                </ul>
         ...
         <div class="headerlinkmenu col-lg-5 col-md-5 col-sm-4  col-xs-12 "> 
            <!-- <div class="headerlinkmenu col-lg-4 col-md-4 col-sm-4 col-xs-10" > -->
              <div class="links" style="margin-top: 10px;">
                 ...
                 <div class="inner-cl">
                   <!--  <div class="block block-language form-language"> -->
                     <div class="block  form-language">
                      ...
                      <div class="lg-cur"><i class="fa fa-user"></i> <span><span class="lg-fr">Welcome <?php foreach ($userpro as $value) { ?><?php echo $value->ufname; ?><?php  } ?></span> <i class="fa fa-angle-down"></i> </span> 
                      </div>
                      <ul>
               ...
               <!--  <div class="wishlist"><a title="My Wishlist" href="wishlist.html"><i class="fa fa-heart"></i><span class="hidden-xs">Wishlist</span></a></div>  -->
                ...
                <?php if(!empty($userpro[0]->user_id) != ''){?>
                  ...
                  <!-- Notification on 15 Jan 2019-->
                <?php $sql= 'SELECT * FROM tbl_notification WHERE notification_status ="UNREAD" AND notification_user_id='.$userpro[0]->user_id;
                     $query= $this->db->query($sql);
                     $value= $query->num_rows(); ?>

                  <div class="Notifications"><a title="My Notifications" id = "noti" class="noti" href="#"  data-toggle="modal" data-id="<?php echo $userpro[0]->user_id;?>"><i class="fa fa-bell"></i><span class="hidden-xs">Notifications<?php if($value!=0){?>( <?php  echo $value; ?> )<?php } ?></span></a></div>
                <?php } else { ?>
  ...
  <!-- end nav --> 
  <!--Notifications Popup Start-->                      <!-- 15 Jan 2019 -->

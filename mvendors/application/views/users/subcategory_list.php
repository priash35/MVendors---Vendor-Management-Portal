                    ...
                    <div class="item-inner">
                      ...
                      <!--   <div class="icon-sale-label sale-left">Sale</div>
                        ...
                        <?php  ?>
                         ...
                         <a href="<?php echo base_url();?>User/sub_category/<?php echo $row->subcategory_id; ?>">
                          <figure > <img class="first-img" src="<?php echo base_url();?>assets/uploads/no_image.jpg" alt="" style="width: 256px; height: 200px;"> </figure>
                          </a>
                           <?php } else { ?>
                            <a href="<?php echo base_url();?>User/sub_category/<?php echo $row->subcategory_id; ?>">
                          <figure > <img class="first-img" src="<?php echo base_url();?>assets/uploads/subcategory/<?php echo $row->sub_category_pic; ?>" alt="" style="width: 256px; height: 200px;"> </figure>
                          </a>
                           <?php }  ?>
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"><a href="<?php echo base_url();?>User/sub_category/<?php echo $row->subcategory_id; ?>"><?php echo $row->sub_category_title; ?></a> </div>

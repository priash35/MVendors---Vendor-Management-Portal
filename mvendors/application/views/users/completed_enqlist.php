        ...
        <div class="col-main col-sm-12 col-xs-12">
          <div class="my-account">
                ...
                <table class="col-md-12" id="table_id">
                  <thead>
                    <tr>
                      ...
                      <th class="th-product">Feedback</th>
                      <th class="th-product">Remark</th>
             ...
             <!-- updated on 14 jan 2019 -->
                    ...
                    <?php if($value->bill_name!="") { ?>
                    <td class="th-details"><a target ="_blank" href="<?php echo $value->bill_name;?>"><button class="button cart-button">View</button></a> </td>
                  <?php }else{?>
                    <td class="th-details"> Not Recived. </td><?php } ?>
          ...
          <!-- updated on 14 jan 2019 -->
                     ...
                     <td class="th-details"><a href="<?php //echo base_url();?>User/final_enq_Status/<?php //echo $value->enq_id;?>"><button class="button cart-button">Click to Complete</button></a> </td> -->

                     <td class="th-details"><?php echo $value->ufeed_feedback;?></td>
                     <td class="th-details"><?php echo $value->ufeed_remark;?></td>
    ...
    <div class="sidebar-account block">
        ...
        <div class="block-content">
          <ul>
            ...
            <li class="current"><a href="<?php //echo base_url('User/completd_enq');?>">Completed Enquiries</a></li>

...
<head>
	...
	<!-- Theme JS files -->
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	...
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/ui/moment/moment.min.js"></script>
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/pickers/daterangepicker.js"></script>

	<!-- Theme JS files -->
	<!--<script src="<?php echo base_url();?>/assets/admin/global_assets/js/plugins/editors/ckeditor/ckeditor.js"></script>-->
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/forms/selects/select2.min.js"></script>
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/demo_pages/form_select2.js"></script>

	<script src="<?php echo base_url();?>assets/admin/assets/js/app.js"></script>
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/demo_pages/dashboard.js"></script>
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/plugins/forms/styling/uniform.min.js"></script>
	<!--<script src="<?php echo base_url();?>/assets/admin/global_assets/js/demo_pages/editor_ckeditor.js"></script>-->
	<script src="<?php echo base_url();?>assets/admin/global_assets/js/demo_pages/form_inputs.js"></script>
	<!-- /theme JS files -->

    ...
    <div class="main container">
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12">
          ...
          <?php } elseif ($this->session->flashdata('event_success')){ ?>
          	 <div class="alert alert-danger alert-styled-left alert-arrow-left alert-dismissible" id="deletesuccess">
          <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
              <div class="font-weight-semibold"><?= $this->session->flashdata('event_success') ?> </div></div>
          <?php } ?>
          <div class="wishlist-item table-responsive">
            <form action="<?php echo base_url('User/forgot_pass');?>" method="post">
          
              <div class="box-authentication">
                <label for="emmail_login">Moible Number<span class="required">*</span></label>
              ...
              <!--   <input type="text" name="oldpass" class="form-control" required>
                ...
                <input name="nupass"  type="text" class="form-control" required> -->
                  <button class="button" name="btn_forgot"> <span>update</span></button>
              </div>
              </form>

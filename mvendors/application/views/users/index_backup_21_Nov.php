        ...
        <ul>
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            ...
            <div class="tp-caption very_big_white skewfromrightshort fadeout"
                          ...
                          style=" font-size:70px; font-weight:800; color:#fe0100;"><?php echo $row->slider_title?> <span style=" color:#000;">sale</span> </div>
                    ...
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.html"><?php echo $row->category_title; ?></a> </div>

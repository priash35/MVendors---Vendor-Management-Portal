...
<div class="content">
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title">Result for "All Sub Category"</h5>
			<a href="<?php echo('addsubcategory'); ?>"><button type="button" class="btn btn-primary legitRipple">Add New Sub Category</button></a>
		</div>
		<table class="table table-bordered datatable-button-init-basic">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $row->sub_category_pro_serv ?></td>
					<td>
					...
					<td><?php echo $row->sub_category_commission; ?></td> 
					<td><?php echo $row->sub_category_price; ?></td>
					<td><?php echo $row->sub_category_c_date; ?></td>
					<td><?php echo $row->sub_category_u_date; ?></td>

        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            <div class="page-title">
               ...
               <?php } else { ?>
              <h2><?php echo $clist[0]->category_title;?></h2>
            </div>
            <div class="toolbar">
              <!--<div class="view-mode">
                <ul>
                ...
                <li class="item ">
                  ...
                  <div class="product-shop">
                   ...
                   <!--  <div class="price-box">
                    ...
                    <div class="actions">
                    <!--   <button class="button cart-button enquery" id="enquery"  title="Add to Cart" type="button">Read More</button> -->

                       <a href="<?php echo base_url();?>User/busines_detils/<?php echo $value->bis_slug;?>" title="Ipsums Dolors Untra">
                      <button class="button cart-button enquery" title="Add to Cart" type="button">Veiw More</button></a>
                      <ul>
        ...
        <div class="modal-content"><!--  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
            <div class="modal-body"> 
                ...
                <?php   if($_SESSION['user_id']!=''){
                  ...
                  <h4>Send Business Enquiry "<span class="text-capitalize" style="color: orangered;"><?php echo $clist[0]->category_title;?></span>"</h4>   <span id="error" class="price"> </span><br>
                <!--  <p class="before-login-text">Welcome back! Sign in to your account</p> -->
                   <input id="cat_id" type="hidden" value="<?php echo $clist[0]->bis_category;?>" class="form-control">
                   <input id="user_id" type="hidden" value="<?php echo $clist[0]->user_id;?>" class="form-control">
                  <label for="emmail_login">Your Name <span class="required">*</span></label>
                  <input id="uname" type="text" class="form-control" value="<?php echo $userpro[0]->ufname;?>" readonly>
                  <label for="password_login">Your Mobile Number <span class="required">*</span></label>
                  <input id="unumber" type="text" class="form-control" value="<?php echo $userpro[0]->uanumber;?>" readonly>
                  <label for="password_login">Your Email Id <span class="required">*</span></label>
                  <input id="uemail" type="email" class="form-control" readonly>

							...
							<div class="card-body">
								...
								<tbody>
												...
												<!-- Custom background -->
													...
													<div class="card">
														<div class="card-body">
															...
															<div class="form-group">
																<label>Email:</label>
																<input type="text" name="vemail" class="form-control" value="<?php echo $value->vemail; ?>" placeholder="Your Email">
															</div>
															<div class="form-group">
																<label>Mobile Number:</label>
																<input type="text" name="vmobile" class="form-control" value="<?php echo $value->vmobile; ?>" placeholder="Mobile Number">
															</div>
									...
									<div class="tab-pane fade" id="left-icon-tab3">
										<div class="col-md-4">
												<!-- Custom background -->
												<form action="<?php echo base_url('Mvendor/change_password');?>" method="post">
													<div class="card">
														<div class="card-body">
															<div class="form-group">
															<input type="hidden" name="vid" class="form-control" value="<?php echo $value->vendor_id; ?>">
																<label>Old Password:</label>
																<input type="text" name="oldpass" class="form-control" value="<?php echo $value->v_password;?>" placeholder="Old Password" required>
															</div>

															<div class="form-group">
																<label>New Password:</label>
																<input type="text" name="newpass" class="form-control" placeholder="Your  password" required>
															</div>

															<div class="form-group mb-0">
																<label>Confirm Password:</label>
																<input type="text" name="conpass" class="form-control" placeholder="Your  password" required>
															</div>
														</div><?php }?>
													</div>

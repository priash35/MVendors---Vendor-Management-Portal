						...
						<div class="tab-content card-body">
							...
							<div class="tab-pane fade show active" id="login-tab1">
								...
								<div class="text-center mb-3">
									...
									<h5 class="mb-0">Login to your Admin Account</h5>
									<!-- <span class="d-block text-muted">Your credentials</span> -->
								</div>
								<?php if ($this->session->flashdata('success')) { ?>
									<div class="alert alert-success alert-styled-right alert-dismissible" id="deletesuccess">
									<button type="button" class="close" data-dismiss="alert"><span>×</span></button>
							        <div class="font-weight-semibold"><?= $this->session->flashdata('success') ?> </div></div>
							    <?php }elseif ($this->session->flashdata('error')) { ?>
							    		<div class="alert alert-danger alert-styled-right alert-dismissible" id="deletesuccess">
									<button type="button" class="close" data-dismiss="alert"><span>×</span></button>

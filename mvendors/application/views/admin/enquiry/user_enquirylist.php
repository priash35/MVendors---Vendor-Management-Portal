		...
		<table class="table table-bordered table-hover datatable-highlight">
			...
			<tbody>
				...
				<td><?php echo $row->enq_id ?></td>
					<td><a href="<?php echo base_url('Inquiry/enquiry_count');?>/<?php echo $row->enq_id ?>"><?php echo $row->ufname.' '.$row->ulname ?></a></td>
					...
					<td class="text-center">
						...
						<?php } else { ?>
						<a href="<?php echo base_url().'Inquiry/update_user_enquiry/'.$row->enq_id;?>" target="_blank"><i class="icon-pencil7"></i></a>
						<?php }?>
					</td>
					<td>
					...
					<td>
						<a href="#" onclick="getCount(<?php echo $row->enq_id ?>)" data-toggle="modal" data-target="#modal_smallgetcount" <i class="icon-zoomin3"></i></a>
					</td>
				</tr>
				<?php  }?>
			</tbody>

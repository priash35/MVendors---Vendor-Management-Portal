        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-sm-4 hidden-xs"> 
              ...
              <div class="welcome-msg "><a href="#">Welcome Mvendors</a></div> <span class="phone hidden-sm">Call Us: +91 9112656464</span> </div>
             
            <!-- top links -->
            <div class="headerlinkmenu col-lg-8 col-md-7 col-sm-8 col-xs-12">
              <div class="links">
                <?php if(!empty($userpro) != ''){?>
                <div class="myaccount"><a title="My Account" href="<?php echo base_url();?>User/user_profile""><i class="fa fa-user"></i><span class="hidden-xs">Welcome <?php foreach ($userpro as $value) { ?><?php echo $value->ufname; ?> <?php echo $value->ulname; ?><?php  } ?></span></a></div>
                <?php } else {?>
                 <div class="myaccount"><a title="My Account" href="<?php echo base_url();?>User/user_profile"><i class="fa fa-user"></i><span class="hidden-xs">My Account</span></a></div>
                   <?php } ?>

...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Import/load_brands_type",
   method:"POST",
   success:function(data)
   {
    $('#imported_bcsv_data').html(data);
   }
  })
 }
 ...
 $('#import_csv').on('submit', function(event){
  ...
  $.ajax({
   url:"<?php echo base_url(); ?>Import/imports_brands_type",
   method:"POST",

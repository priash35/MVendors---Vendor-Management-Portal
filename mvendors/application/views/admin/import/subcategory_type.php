  ...
  <br />
  <div id="imported_subbcsv_data"></div>
									</a>
			                	</div>
							</div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Import/load_subcategory_type",
   method:"POST",
   success:function(data)
   {
    $('#imported_subbcsv_data').html(data);
   }
  })
 }
 ...
 $('#import_csv').on('submit', function(event){
  ...
  $.ajax({
   url:"<?php echo base_url(); ?>Import/imports_subcategory_type",
   method:"POST",
